		...
		<div id="table-content">
			...
			<form id="mainform" action="team_delete.php">
				...
				<tr>
					...
					{
					foreach($data as $name)						{						echo"<tr class='showdata'>";						echo "<td><input value='$name[0]' name='todelete[]' type='checkbox'/></td>";						echo "<td>".$name[1]."</td>";						echo "<td>".$name[2]."</td>";						echo "<td><img src='".$name[3]."' width='50px' height='50px'></td>";						echo "<td>".$name[4]."</td>";						echo "<td class='options-width'><center><a href='team_delete.php?id=$name[0]' title='Delete' class='icon-2 info-tooltip'></a><a href='team_edit.php?edit_id=$name[0]' title='Edit' class='icon-1 info-tooltip'></a></center></td>";						echo "</tr>";						}					}	
					?>
				</tr>
				</tr>
				</table>
