<?php 
$page_title="Testimonial >> View Testimonial";
...
<!--  start page-heading -->
	...
	<tr>
		...
		<div id="table-content">
				...
				<!--  start product-table ..................................................................................... -->
			<form id="mainform" action="test_delete.php">
				<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
				<tr>
					<th class="table-header-check"><a id="toggle-all" ></a> </th>					<th class="table-header-repeat line-left minwidth-1"><a href="">Client</a></th>						<th class="table-header-repeat line-left minwidth-1"><a href="">Date Time</a></th>						<th class="table-header-options line-left"><a href="">Options</a></th>
				</tr>
					...
					{
					foreach($data as $name)						{						echo"<tr class='showdata'>";						echo "<td><input value='$name[0]' name='todelete[]' type='checkbox'/></td>";						echo "<td>".$name[2]."</td>";						echo "<td>".$name[4]."</td>";						echo "<td class='options-width'><center><a href='test_delete.php?id=$name[0]' title='Delete' class='icon-2 info-tooltip'></a><a href='test_edit.php?edit_id=$name[0]' title='Edit' class='icon-1 info-tooltip'></a></center></td>";						echo "</tr>";						}					}	
					?>
				</tr>
				</tr>
				</table>
